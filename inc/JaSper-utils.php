...
function child_social_media_icons() {
	...
	<div class="proper">
        ...
        <div class="twitter"> 
        	<a href="http://twitter.com/share" class="socialite twitter-share" data-text="<?php the_title(); ?>" data-url="<?php the_permalink($post->ID); ?>" data-count="horizontal" data-via='NM_Fitness' rel="nofollow" target="_blank"><span class="vhidden">Share on Twitter</span></a> 
		</div>
