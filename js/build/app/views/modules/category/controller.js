define([
    ...
    var CategoryWidget = Backbone.View.extend({
        ...
        initialize: function(options){
            ...
            this.collection.fetch({ success : this.onCollectionLoaded, dataType: "jsonp" });
        },
        ...
        build: function(){
            this.collection.each( function( categoryModel ){
                var categoryWidgetItem = new CategoryWidgetItem({model:categoryModel});
